...
# profile_program matrix_test_original "${events_original_transformer[@]}"
profile_program eigen3_matrix "${events_matrix_transformer[@]}"
profile_program eigen3_matrix_O2 "${events_matrix_transformer[@]}"
